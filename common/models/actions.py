...
class DomainAction(BaseModel):
    ...
    agent_id: Optional[uuid.UUID] = Field(None, description="Identificador del agente que procesa o está asociado con esta acción. Opcional para servicios que no operan con agentes específicos (ej: embedding, ingestion).")
